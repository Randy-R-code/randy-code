            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Comprehensive documentation for all InfraLens checks. Each
                  check is executed server-side using Next.js server actions,
                  designed to be fast, non-intrusive, read-only, and safe for
                  production websites. All checks run in parallel for optimal
                  performance.
                </p>
              </div>
            </div>
            ...
            <Card className="border-border bg-card/50">
              <CardHeader>
                ...
                <CardDescription className="text-muted-foreground">
                  InfraLens performs 20 independent checks across 6 categories
                  to analyze the technical exposure and configuration of a
                  website. Each check is modular, type-safe, and focuses on a
                  specific aspect of infrastructure, security, or configuration.
                </CardDescription>
              </CardHeader>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        The check&apos;s condition genuinely doesn&apos;t apply
                        to this target — doesn&apos;t affect the score
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Badge
                      ...
                      <span>
                        Ran, but the detection method can&apos;t reach a
                        reliable conclusion (e.g. DKIM/DNSSEC) — doesn&apos;t
                        affect the score
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        Couldn&apos;t be determined (e.g. an optional
                        third-party lookup was down) — doesn&apos;t affect the
                        score
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <p>
                      <strong>MX:</strong> Mail Exchange records for email
                      routing
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      Authorities may issue certificates for the domain — shown
                      as evidence, absence isn&apos;t treated as a problem since
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    Checks the two email-authentication signals reliable enough
                    to confirm pass/warning/fail on their own:
                  </p>
                  <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                    <li>
                      <strong>SPF:</strong> Sender Policy Framework for email
                      authentication — also flags multiple SPF records, which
                      RFC 7208 treats as invalid
                    </li>
                    <li>
                      <strong>DMARC:</strong> Domain-based Message
                      Authentication — its policy (none/quarantine/reject) is
                      reported, with p=none flagged as monitor-only, not real
                      enforcement
                    </li>
                  </ul>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    selector isn&apos;t published anywhere. Finding one is a
                    real, confirmed pass; not finding one there is reported as
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    implied absent. A separate check, kept apart from DNS
                    Security above for the same reason as DKIM.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-foreground mb-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    InfraLens uses the ipapi.co API (optional) to identify
                    public IP address, Autonomous System Number (ASN), hosting
                    provider, geographic location, and IPv6 availability. This
                    provides a high-level view of where and how the site is
                    hosted. The API key is optional—the service works without it
                    but with rate limits. Informational only — inventory, not a
                    quality judgment, so it never affects the score.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    ...
                    just whether they&apos;re present, but whether their value
                    is actually safe (e.g. a Content-Security-Policy that still
                    allows <code>unsafe-inline</code> counts as weak, not
                    strong). A check passes only when every header is present
                    with a safe value; missing or weak headers trigger
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <p>
                      ...
                      requests — flagged as weak on unsafe-url
                    </p>
                    <p>
                      <Badge variant="outline" className="mr-2 border-border">
                        Permissions-Policy
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    redirect loops, and a chain that downgrades from HTTPS back
                    to HTTP partway through (treated as a failure). Each
                    hop&apos;s URL and status code is recorded, and a hostname
                    change between the first hop and the final URL is surfaced
                    as informational evidence. Clean redirect chains improve
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    ...
                    according to RFC 9116. This file provides security
                    researchers with contact information and vulnerability
                    disclosure policies. The check verifies:
                  </p>
                  <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                    <li>
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    A properly configured security.txt helps security
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    always a probabilistic signal, never a confirmed detection —
                    a real WAF can hide its fingerprint, and a header alone
            ...
            <Card className="border-border bg-card/50">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    InfraLens checks for the presence of robots.txt, HTTP
                    status, and basic syntax validity, and reports whether it
                    disallows all crawlers under User-agent: * (an indexing
                    signal, not a vulnerability) and which Sitemap: URLs it
                    declares. robots.txt controls crawler access and indexing
                    behavior.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    first, then falls back to /sitemap.xml and
                    /sitemap_index.xml — at most 3 locations, never recursing
                    into a sitemap index&apos;s child sitemaps. Signals include
                    presence, format (XML / index), and basic URL count.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-foreground mb-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    requests to detect unreachable or broken links — this stays
                    a signal, not a crawler.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-border bg-card/50">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    InfraLens inspects Open Graph tags, Twitter Card metadata,
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    ...
                    weakest signal). This check is purely informational and
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    generic value like &quot;nginx&quot; or
                    &quot;cloudflare&quot; alone isn&apos;t treated as an
                    information leak.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    ...
                    accessibility audit — it looks at a handful of observable
                    HTML signals that affect screen readers and assistive
                    technologies:
                  </p>
                  <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                    <li>
                    ...
                    <li>
                      <strong>ARIA landmarks:</strong> Semantic HTML elements
                      and ARIA roles (header, nav, main, footer)
                    </li>
                    <li>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    ...
                    — it doesn&apos;t replace Lighthouse, WebPageTest, or field
                    Core Web Vitals, and never fabricates a metric it can&apos;t
                    actually measure:
                  </p>
                  <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                    <li>
                      Total response time (DNS + connect + TTFB + download
                      combined — connection setup and TTFB aren&apos;t
                      separately observable through a server-side fetch, so
                      they&apos;re not reported individually)
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    website&apos;s availability, not historical uptime tracking
                    or monitoring.
                  </p>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    ...
                    check; informational-only checks (like WAF/CDN detection)
                    have weight 0. A category&apos;s total is simply the sum of
                    its checks&apos; weights, shown here for a report where
                    every check runs normally:
                  </p>
                  <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                    ...
                    <li>
                      Info / Not applicable / Inconclusive / Unavailable /
                      Error: excluded from the score entirely — never counted
                      for or against the site
                    </li>
                  </ul>
                </div>
                <div>
            ...
            <Card className="border-border bg-card/50">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  ...
                  page reads two JSON reports you export from InfraLens and
                  shows the score change, category-by-category deltas, and every
                  check that improved, regressed, or otherwise changed between
                  them. It runs entirely in your browser — neither file is sent
                  anywhere. Reports exported by an incompatible major version of
                  InfraLens are refused with an explanation rather than compared
                  as if they used the same vocabulary.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border bg-card/50">
              ...
              <CardContent>
                <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
                  ...
                  <li>
                    <strong>Network-dependent:</strong> Results may vary based
                    on network conditions, DNS resolver location, and server
                    load.
                  </li>
                  <li>
                    <strong>Single snapshot:</strong> Reachability and
                    performance checks represent a single point in time, not
                    historical monitoring.
                  </li>
                  <li>
                    <strong>Indicators, not guarantees:</strong> Results should
                    be interpreted as indicators to guide further investigation,
                    not as definitive security assessments.
                  </li>
                </ul>
              </CardContent>
            </Card>
