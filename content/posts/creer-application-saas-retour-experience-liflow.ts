...
const post: PostData = {
  ...
  content: `
<p><em>Note : cet article date de novembre 2025 et décrit une version antérieure de Liflow, centrée sur le partage par capsules. Le produit a depuis été entièrement repensé — voir <a href="/articles/liflow-refonte-souvenirs-familiaux">l'article de mai 2026</a> pour la version actuelle, recentrée sur la timeline de souvenirs familiaux.</em></p>
